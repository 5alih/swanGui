...
int main() 
{
	...
	SwanGui swanGui({
		...
		sw(Panel)("my so very very cool panel with a long long name to test out of bounds rendering", sx{ .position= (Vector2){500, 150}, .size= (Vector2){350, 500}, .font= custom_font }, util{ .can_rescale= true, .can_move= true }),
	});
